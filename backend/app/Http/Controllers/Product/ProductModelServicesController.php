...
class ProductModelServicesController extends Controller {
    /**
    ...
    public function index(Request $request) {
        ...
        try {
            ...
            $query = ProductModelServices::query();
    ...
    public function show($id) {
        ...
        $record = ProductModelServices::where('id', $id)
            ->first();
    ...
    public function store(Request $request) {
        try {
            // create a new record
            $record = ProductModelServices::create($request->all());
    ...
    public function update(Request $request, $id) {
        try {
            // Find the record by ID
            $record = ProductModelServices::find($id);
