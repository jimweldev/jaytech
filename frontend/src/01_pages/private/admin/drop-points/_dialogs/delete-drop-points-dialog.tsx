...
type DeleteDropPointDialogProps = {
  open: boolean;
  setOpen: (open: boolean) => void;
  refetch: () => void;
};

const DeleteDropPointDialog = ({
  open,
  setOpen,
  refetch,
}: DeleteDropPointDialogProps) => {
  ...
  const onSubmit = async (e: FormEvent<HTMLFormElement>) => {
    ...
    toast.promise(
      mainInstance.delete(`/drop-points/${selectedDropPoint?.id}`),
      {
        loading: 'Loading...',
        success: () => {
          refetch();
      ...
      <DialogContent>
        ...
        <form onSubmit={onSubmit}>
          ...
          <DialogBody>
            ...
            {/* Modal title */}
            <h3 className="text-center text-xl">Delete Drop Point</h3>
...
export default DeleteDropPointDialog;
